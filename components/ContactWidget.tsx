...
export default function ContactWidget() {
  ...
  return (
    <>
      {/* Fallback WhatsApp Button (if widget doesn't load) - positioned on LEFT */}
      <a
        href="https://wa.me/919198846529?text=Hello%20Kindway%20Biorezens"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 left-6 z-40 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 transition-all hover:scale-110"
